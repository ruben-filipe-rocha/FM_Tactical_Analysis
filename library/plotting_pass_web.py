    ...
    for _, r in ranked_timestamps.iterrows():
       ...
       # ==========================
        ...
        if nome:
            ...
            legenda_equipa = dict(
                x=0.25, y=-0.09,  # posição superior (ligeiramente acima da segunda)
            ...
            legenda_jogador = dict(
                x=0.25, y=-0.16,  # posição ligeiramente mais abaixo
                xref="paper", yref="paper",
        ...
        def extrair_metricas(equipa_nome, ts):
            ...
            # ==========================
            #"— Team With Ball —": "",
            #"Space Creation – Stretch Index (yd)": f(l.get("stretch_index")),
            #"Space Creation – Surface Area (yd²)": f(l.get("espaco_criado")),
            #"Space Creation – Lateral extension (yd)": f(l.get("team_width")),

            # ==========================
            # Defensive metrics
            # ==========================
            #"— Team Without Ball —": "",
            "Compactness (yd²)": f(l.get("compactacao")),
            "Team Balance – Players Behind Ball (%)": f(l.get("indice_equilibrio_defensivo")),
            "Pressing – Centroid Distance (yd)": f(l.get("team_centroid_distance")),
        }
